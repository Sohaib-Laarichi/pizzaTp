...
import com.example.pizaatp.adapter.ProduitAdapter;
import com.example.pizaatp.classes.Produit;
import com.example.pizaatp.service.ProduitService;
...
public class ListPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProduitAdapter adapter = new ProduitAdapter(this, pizzaList);
        listView.setAdapter(adapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Produit produit = pizzaList.get(position);
    ...
    private void sharePizzaRecipe() {
        String message = "Best pizza share ever!";
